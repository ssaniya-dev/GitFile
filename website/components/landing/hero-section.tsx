...
<<<<<<< HEAD
    <a
      href="https://devpost.com/software/gitfile"
      target="_blank"
    ...
    >
      <TextShimmer className="inline-flex items-center justify-center">
        <span>Upvote us on Devpost</span>{" "}
...
>>>>>>> 408b20421745295c6d5df0d2de5b51abb03b5334
        a new way to
        <br className="hidden md:block" /> track your files.
      </h1>
      <p className="mb-12 text-lg tracking-tight text-gray-400 md:text-xl text-balance translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms]">
        Version control for your files, simplified – {" "}
        <br className="hidden md:block" /> your personal GitHub for everything.
      </p>
      <Button onClick={() => router.push('/demo')} className="translate-y-[-1rem] animate-fade-in gap-1 rounded-lg text-white dark:text-black opacity-0 ease-in-out [--animation-delay:600ms]">
